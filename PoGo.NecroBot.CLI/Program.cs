...
namespace PoGo.NecroBot.CLI
{
    ...
    {
    	public static ResultForm result;
		private static object lockobj;

		public static int a = 0; //ポケモン
		public static int b = 0; //ポケモンストップ
		public static int c = 0; //進化
		public static int d = 0; //転送
        ...
        private static void Main(string[] args)
        {
			...
			lock (lockobj)
			{
				var ts = new ThreadStart(StartThread);
